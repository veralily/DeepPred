...
from .bert_score.bert_score import BertScore
from .repetition.repetition import Repetition
from .distinct.distinct import Distinct
...
class QGEvalCap:
    ...
    def evaluate(self):
        ...
        for scorer, method in scorers:
            ...
            if method in ["Repetition", "Distinct"]:
                score, scores = scorer.compute_score(self.res)
            else:
