...
def run_data(args):
    if "conceptnet" in args.data_name:
        from Data.conceptnet_task_data import TaskData
    elif args.data_name == "v4_atomic":  # "v4_atomic" in args.data_name
        from Data.atomic_task_data import TaskData
    elif args.data_name == "ART":
        from Data.art_task_data import TaskData
    else:
        assert args.data_name == "event_story"
        from Data.story_task_data import TaskData
...
def load_train_valid_data(args, tokenizer):
    if args.data_name == "event_story":
        from Data.story_task_data import BartProcessor
    elif args.data_name == "ART":
        from Data.art_task_data import BartProcessor
    else:
        from Data.atomic_task_data import BartProcessor
