...
class TaskData(object):
    def __init__(self, raw_data_path, preprocessor=None, is_train=True, context_mode=None, logger=None):
    ...
    def read_data(self, relations=None):
        ...
        self.logger.info(f"read sentence data from {str(self.data_path)}")
